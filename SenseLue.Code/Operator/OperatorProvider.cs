...
namespace SenseLue.Code
{
    public class OperatorProvider
    {
        ...
        private string LoginUserKey = "SenseLue_loginuserkey_2016";
        ...
        public void AddCurrent(OperatorModel operatorModel)
        {
            ...
            WebHelper.WriteCookie("SenseLue_mac", Md5.md5(Net.GetMacByNetworkInterface().ToJson(), 32));
            WebHelper.WriteCookie("SenseLue_licence", Licence.GetLicence());
        }
